...
BEGIN_MESSAGE_MAP(CpathspeedApp, CWinApp)
...
// 唯一一個 CpathspeedApp 物件

CpathspeedApp theApp;


// CpathspeedApp 初始化

BOOL CpathspeedApp::InitInstance()
{
